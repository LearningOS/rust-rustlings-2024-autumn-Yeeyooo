...
//? To return a ParseIntError, you need to:
//? 1.Use a return type like Result<T, ParseIntError>, where T is the expected
//? type(e.g. i32, u32, etc.)
//? 2.Handle the parsing logic using parse() and propogate any errors using ? or manually
//? returning Err(e)
